...
// export async function generarPDF_Base64(cliente, empleado, factura, detallesVenta) {
//     try {
...
//         pagina.drawText(cliente.idCliente, {
//             x: 291,
//             y: 232.3,
//             size: 14,
//             color: rgb(0, 0, 0), // Color negro,
...
//         pagina.drawText(empleado.nombre.toString(), {
//             x: 80,
//             y: 76.5,
//             size: 14,
//             color: rgb(0, 0, 0), // Color negro,
...
//                   if(producto.idProducto == detalleVenta.idProducto){
